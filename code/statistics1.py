...
df_bike['1'].plot
# convert the ‘time’ column into days of the week and months
...
bikes_day_tot = df_bike.groupby('day').sum()
bikes_month_tot = df_bike.groupby('month').sum()
...
months= list(bike_days_med.index)
...
#Create the plot layout how yo put the pieces in the dataframe
